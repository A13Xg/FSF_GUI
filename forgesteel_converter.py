...
def main():
    ...
    parser.add_argument('output', help='The path to save the converted Foundry VTT .json file')
    parser.add_argument('--compendium', 
    ...
    try:
        ...
        compendium_items = load_compendium_items(str(compendium_path), verbose=args.verbose)
    ...
    try:
        ...
        foundry_char = convert_character(forgesteel_char, compendium_items, 
